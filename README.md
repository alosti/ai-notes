...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [Costruire con gli LLM](corso-llm/)       | LLM fundamentals, RAG, streaming e AI agents — dalla teoria alle decisioni architetturali reali                |
| [Corso su MCP](corso-mcp/)                | Model Context Protocol: architettura, trasporti, primitivi                                                     |
| [Machine Learning, Deep Learning e Trading](ml-dl-trading/) | ML e DL applicati al trading: fondamenta, produzione e realtà dei mercati — per trader, non per data scientist |
| [Approfondimenti](approfondimenti/)       | Letture, analisi e riflessioni su temi specifici — senza ordine sequenziale                                    |
| [Il codice che non ho scritto](vibe-coding-it/) / [The Code I Didn't Write](vibe-coding-en/) | Come ho sviluppato ARIA con Claude Code — sessioni reali, prompt reali, errori reali / How I built ARIA with Claude Code — real sessions, real prompts, real mistakes |
